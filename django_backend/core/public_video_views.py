...
@never_cache
def serve_public_video(request, video_path):
    """
    Serveur de vidéos public (sans authentification)
    """
    try:
        ...
        print(f"✅ Servir vidéo: {video_path} ({file_size} bytes, {content_type})")
        ...
        # Headers pour le streaming et CORS
