...
export default function StudentProfilePage() {
      ...
      try {
        ...
        setProfileData({
          user: {
            ...
            first_name: "Spéro",
            last_name: "ASHANTE",
            email: "spero.ashante@example.com",
          ...
          profile: {
            ...
            current_grade: "3ème",
            school_name: "Lycée Blaise Diagne",
            study_time_total: 45,
            ...
            goals: "Réussir mon brevet avec mention très bien",
            total_exams_taken: 8,
            average_exam_score: 82.3,
            streak_days: 7,
            is_adult: false
          }
        })
        setCourseProgress([
          ...
          },
          {
            ...
            progress: 100,
            completed: true,
            last_accessed: "2024-01-19T16:00:00Z",
            score: 92
          },
          {
            id: "3",
            ...
            progress: 60,
            completed: false,
            last_accessed: "2024-01-18T13:00:00Z",
            score: 78
          }
        ])
      } finally {
  ...
  if (loading) {
    return (
      <AuthGuard>
        <StudentSidebar>
          <div className="flex-1 p-6 bg-laha-background flex items-center justify-center">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-6">
                    <Avatar className="h-24 w-24">
                      <AvatarImage src="" />
                      <AvatarFallback className="text-2xl bg-laha-gold text-laha-black">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <Badge className="bg-green-500 text-white">
                          ...
                          Série de {profileData.profile.streak_days} jours
                        </Badge>
                      </div>
                  ...
                  <Card className="bg-laha-card border-laha-border">
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-laha-text">{profileData.user.email}</span>
                      </div>
                      {profileData.user.phone && (
                        <div className="flex items-center gap-2">
                          <Phone className="h-4 w-4 text-laha-text-secondary" />
                          <span className="text-laha-text">{profileData.user.phone}</span>
                        </div>
                      )}
                      {profileData.profile.country && (
                        <div className="flex items-center gap-2">
                          <MapPin className="h-4 w-4 text-laha-text-secondary" />
                          <span className="text-laha-text">{profileData.profile.country}</span>
                        </div>
                      )}
                      {profileData.profile.date_of_birth && (
                        <div className="flex items-center gap-2">
                          <Calendar className="h-4 w-4 text-laha-text-secondary" />
                          <span className="text-laha-text">{formatDate(profileData.profile.date_of_birth)}</span>
                        </div>
                      )}
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-laha-card border-laha-border">
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-laha-text-secondary">Niveau</span>
                        <span className="font-medium text-laha-text">{profileData.profile.school_level || 'Non défini'}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-laha-text-secondary">Classe</span>
                        <span className="font-medium text-laha-text">{profileData.profile.current_grade || 'Non définie'}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-laha-text-secondary">École</span>
                        <span className="font-medium text-laha-text">{profileData.profile.school_name || 'Non définie'}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-laha-text-secondary">Style d'apprentissage</span>
                        <span className="font-medium text-laha-text">{profileData.profile.learning_style || 'Non défini'}</span>
                      </div>
                    </CardContent>
                  </Card>
                </div>
