        ...
        <div className="max-w-2xl mx-auto">
          <div className="shadow-input bg-laha-black-light/50 backdrop-blur-sm rounded-2xl border border-laha-gold-dark/30 p-8">
            <div className="text-center mb-2">
              <h1 className="text-3xl font-bold text-laha-gold">Inscription Parent</h1>
              <p className="text-sm text-laha-gold-light/70 mt-2">Créez votre compte parent pour suivre les progrès de vos enfants</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <Label htmlFor="occupation" className="text-laha-gold-light">Profession</Label>
                  <Input
                  id="occupation"
